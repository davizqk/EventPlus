...
public class InstituicaoController : ControllerBase
{
    ...
    /// <summary>
    /// Endpoint da API que faz a chamada para um método de busca uma instituição específica
    /// </summary>
    /// <param name="id">Id da instituição buscada</param>
    /// <returns>Status code 200 e a instituição cadastrada</returns>
    [HttpGet("{id}")]
    ...
    /// <summary>
    /// Endpoint da API que faz chamada para o método de deletar uma instiuição
    /// </summary>
